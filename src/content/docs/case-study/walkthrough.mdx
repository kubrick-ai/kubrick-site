...
import ingestionWalkthrough from "@assets/demos/walkthrough/ingestion-walkthrough.mp4";
import searchTextWalkthrough from "@assets/demos/walkthrough/search-text-walkthrough.mp4";
import searchImageWalkthrough from "@assets/demos/walkthrough/search-image-walkthrough-1.mp4";
import searchVideoWalkthrough from "@assets/demos/walkthrough/search-video-walkthrough.mp4";
...
<video controls muted width="1000">
  <source src={ingestionWalkthrough} type="video/mp4" />
...
<video controls muted width="1000">
  <source src={searchTextWalkthrough} type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls muted width="1000">
  <source src={searchImageWalkthrough} type="video/mp4" />
  Your browser does not support the video tag.
</video>
...
<video controls width="1000">
  <source src={searchVideoWalkthrough} type="video/mp4" />
  Your browser does not support the video tag.
</video>
