...
event-driven workers, with embedding requests flowing through both producer and consumer
...
<ThemedDiagram src='database_schema.png' alt='Database Schema Chart' />
