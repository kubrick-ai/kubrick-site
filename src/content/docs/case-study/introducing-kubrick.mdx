...
Kubrick provides a video ingestion and search pipeline designed for developers
who want to enhance their applications with semantic video search while
retaining full ownership of their video data. It provides automated deployment
to AWS via a guided CLI tool and an easy-to-use API with a playground for
experimentation. We wanted to strip away the complexity of large enterprise
systems by focusing on the core challenge: accurate and efficient retrieval of
