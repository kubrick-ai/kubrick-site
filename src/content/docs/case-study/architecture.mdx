...
import lightArchitecture from "@assets/diagrams/light/simplified_architecture.png";
import darkArchitecture from "@assets/diagrams/dark/simplified_architecture.png";
...
<Image
  src={lightArchitecture}
  alt='Simplified Architecture Diagram'
  class='dark:sl-hidden'
  loading='lazy'
/>
<Image
  src={darkArchitecture}
  alt='Simplified Architecture Diagram'
