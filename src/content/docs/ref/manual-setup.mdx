...
For most users, the [Quick Start](/ref/quick-start) CLI guide is recommended.
:::
...
- **AWS CLI** (>= 2.15.0) - [Installation Guide](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
...
For production deployments, consider custom policies following the principle of least privilege.
:::

## Project Structure Overview

Understanding the Kubrick project structure will help with customization and troubleshooting:
...
- kubrick/
  ...
  - lambda/                 # Serverless functions
    ...
    - build-package.sh       # Lambda build script
  ...
  - build-all-packages.sh   # Build all Lambda packages
  - README.md
</FileTree>
...
- **CLI Tool**: Try the [Quick Start](/ref/quick-start) for simpler deployments
